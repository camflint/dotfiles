...
"  mnemonic means 'l' for 'less'
nnoremap <leader>l :call Navmode()<cr>
...
" Mapping: Save a file more efficiently than using ":w" command.
...
" Don't redraw - set if experiencing slowdown.
"set lazyredraw
...
" Mapping: Search buffers (requires fzf plugin).
...
" LSP (code navigation and completion).
